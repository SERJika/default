...
/**
 * webtonica Contact widget
 *
 * @package webtonica
 * @since 0.1.0
 */

class webtonica_Contact_Widget extends WP_Widget {
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'webtonica_contact',
			'description' => __( 'Display contact information.', 'webtonica' ),
		);
		parent::__construct( 'webtonica_contact', 'webtonica: Contact', $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'contact_title' ) ); ?>"><?php _e( 'Title:', 'webtonica' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'contact_text' ) ); ?>"><?php _e( 'Contact Text:', 'webtonica' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'contact_number' ) ); ?>"><?php _e( 'Contact Number:', 'webtonica' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'contact_email' ) ); ?>"><?php _e( 'Email Address:', 'webtonica' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'contact_address' ) ); ?>"><?php _e( 'Site Address:', 'webtonica' ); ?></label>
