...
/**
 * webtonica About widget
 *
 * @package webtonica
 * @since 0.1.0
 */

class webtonica_About_Widget extends WP_Widget {
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'webtonica_about',
			'description' => __( 'Display site logo and info.', 'webtonica' ),
		);
		parent::__construct( 'webtonica_about', 'webtonica: About', $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'logo_url' ) ); ?>"><?php _e( 'Logo URL:', 'webtonica' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'info_text' ) ); ?>"><?php _e( 'Info Text:', 'webtonica' ); ?></label>
